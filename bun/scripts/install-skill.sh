...
# Prefer: npx skills add shhac/agent-notion
# See: https://skills.sh

ROOT="$(cd "$(dirname "${BASH_SOURCE[0]}")/.." && pwd)"
SRC="${ROOT}/skills/agent-notion"
...
install_one() {
  local dest_root="$1"
  local dest="${dest_root}/agent-notion"
...
echo ""
echo "Tip: For more agents, use: npx skills add shhac/agent-notion"
