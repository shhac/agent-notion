    ...
    defineCommand({
      ...
      action: async () => {
        try {
          ...
          if (v3Session && v3Token) {
            ...
            try {
              ...
              printJson({
                ...
                error: "Desktop token is present but invalid or expired.",
          ...
          const defaultWs = defaultAlias ? allWorkspaces[defaultAlias] : undefined;
          ...
          printError(err instanceof Error ? err.message : "Status check failed");
        }
      },
    }),
  );
